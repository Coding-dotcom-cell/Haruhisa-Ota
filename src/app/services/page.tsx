...
const departments = [
  {
    title: "成人発達障害専門外来",
    body: "ADHD・自閉スペクトラム症など、思春期以降の成人例を中心に対応している。",
  },
  {
    title: "ADHD",
    body: "不注意・多動性・衝動性などの症状について、評価から治療まで対応する。",
  },
  {
    title: "自閉スペクトラム症",
    body: "対人関係やこだわりに関するご相談など、成人例を中心に診療している。",
  },
  {
    title: "脳画像・認知神経科学研究",
    body: "発達障害の病態解明に向けた脳画像研究・臨床研究に取り組んでいる。",
  },
];
